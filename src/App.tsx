...
const SKINS = [
  ...
  },
  {
    ...
    downloadUrl: "https://drive.google.com/file/d/1UtIrRU9kfxWRdL-ghRnqXOofJRUuKvjc/view?usp=sharing",
    date: "26.08.13",
  },
  {
    id: 3,
                ...
                <div className="relative border-l-2 border-slate-100 pl-4 space-y-6 py-1">        
                   <div className="relative group">
                    ...
                    <div className="flex flex-col md:flex-row md:items-center gap-2 md:gap-4">
                      ...
                      <p className="text-sm text-slate-700 font-medium">WMII PLAY SKIN for Beatoraja의 Bmz player 호환문제 수정</p>
                    </div> 
                  </div>  
                            <div className="relative group">
                    <div className="absolute -left-[21px] top-1.5 w-2 h-2 rounded-full bg-point ring-4 ring-white transition-all group-hover:scale-125" />
