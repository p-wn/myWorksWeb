...
const SKINS = [
    ...
    downloadUrl: "https://drive.google.com/file/d/1_vp7aDaRn6lzIUoGKdWUYWuXw1HKbb3p/view?usp=sharing",
    date: "26.05.07",
  },
  {
    id: 1,
    ...
    downloadUrl: "https://drive.google.com/file/d/1F-VXHyVoJanxSobCDat-QeoOvJJO13eC/view?usp=sharing",
    date: "26.05.07",
  },
  {
    id: 2,
            ...
            <div className="mb-16 p-6 bg-white rounded-2xl border border-slate-100 shadow-sm">
              ...
              <div className="space-y-3">
                <div className="flex flex-col md:flex-row md:items-center gap-2 md:gap-4">
                  <span className="text-xs font-mono font-bold text-point bg-teal-50 px-2 py-0.5 rounded w-fit">26.05.07 - 2</span>
                  <p className="text-sm text-slate-600 font-medium">WMII RESULT SKIN 게이지명이 ex-hard 단위까지 제대로 표시되도록 수정 / WMII PLAY SKIN Betoraja용 게이지명이 ex-hard단위까지 표시되도록 수정</p>
                </div>  
                 <div className="flex flex-col md:flex-row md:items-center gap-2 md:gap-4">
