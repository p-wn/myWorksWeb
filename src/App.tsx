...
const SKINS = [
  {
    ...
    downloadUrl: "https://drive.google.com/file/d/1VKTK9F-UI8ZOxb-us50FQRJG1QmNFFK7/view?usp=sharing",
    date: "26.08.30",
  },
  {
    id: 2,
    ...
    category: "Beatoraja",
    description: "Beatoraja & bmz-player용 FHD 플레이스킨. AC,WIDE 비율, 7,14,5,10 keys 대응",
    images: [
    ...
    downloadUrl: "https://drive.google.com/file/d/1sI6MONAlvH5MMhGRmsRn96w_nfBg4bzb/view?usp=sharing",
    date: "26.09.06",
  },
  {
    id: 3,
    ...
    downloadUrl: "https://drive.google.com/file/d/1iEhZOGND5h6hFvQse3SLGiSd4kpcmIdk/view?usp=sharing",
    date: "26.08.09",
  },
  {
    id: 4,
              ...
              <div className="space-y-4 max-h-[260px] overflow-y-auto pr-2 scrollbar-thin scrollbar-thumb-slate-200 scrollbar-track-transparent">
                <div className="relative border-l-2 border-slate-100 pl-4 space-y-6 py-1"> 
                    ...
                    <div className="flex flex-col md:flex-row md:items-center gap-2 md:gap-4">
                      <span className="text-xs font-mono font-bold text-point bg-teal-50 px-2.5 py-1 rounded-lg w-fit">26.09.06</span>
                      <p className="text-sm text-slate-700 font-medium">WMII PLAY SKIN for Beatoraja GHOST 숫자 색상 흰색/빨간색 또는 흰색으로만 표시하는 옵션 추가(다음랭크까지 점수도 같이 변함)</p>
                    </div> 
                  </div>
                        <div className="relative group">
                    <div className="absolute -left-[21px] top-1.5 w-2 h-2 rounded-full bg-point ring-4 ring-white transition-all group-hover:scale-125" />
                    <div className="flex flex-col md:flex-row md:items-center gap-2 md:gap-4">
                      <span className="text-xs font-mono font-bold text-point bg-teal-50 px-2.5 py-1 rounded-lg w-fit">26.08.31</span>
                      <p className="text-sm text-slate-700 font-medium">WMII PLAY SKIN AC DP, WIDE DP에 판정선쪽 GLOW가 1P,2P측이 깜박이는 타이밍이 달랐던걸 수정</p>
                    </div> 
                  </div>
                           <div className="relative group">
                    <div className="absolute -left-[21px] top-1.5 w-2 h-2 rounded-full bg-point ring-4 ring-white transition-all group-hover:scale-125" />
                    <div className="flex flex-col md:flex-row md:items-center gap-2 md:gap-4">
                      <span className="text-xs font-mono font-bold text-point bg-teal-50 px-2.5 py-1 rounded-lg w-fit">26.08.30</span>
                      <p className="text-sm text-slate-700 font-medium">WMII PLAY SKIN에 bmz용 판정모드를 이펙터에 추가하는 기능 추가, WMII RESULT SKIN에 BMZ용 판정모드 표시 추가 및 F-RAN, MF-RAN표시 추가</p>
                    </div> 
                  </div>
                        <div className="relative group">
                    <div className="absolute -left-[21px] top-1.5 w-2 h-2 rounded-full bg-point ring-4 ring-white transition-all group-hover:scale-125" />
                    <div className="flex flex-col md:flex-row md:items-center gap-2 md:gap-4">
                      ...
                      <p className="text-sm text-slate-700 font-medium">WMII PLAY SKIN for Beatoraja의 Asssist Easy, Hazard의 게이지 색상 분리, 메탈 프레임 느낌 배경 이미지 추가, HCN 노트 표시문제 수정</p>
                    </div> 
                  </div>  
                  <div className="relative group">
                    <div className="absolute -left-[21px] top-1.5 w-2 h-2 rounded-full bg-point ring-4 ring-white transition-all group-hover:scale-125" />
                    ...
                    <div className="absolute -left-[21px] top-1.5 w-2 h-2 rounded-full bg-point ring-4 ring-white transition-all group-hover:scale-125" />
                    <div className="flex flex-col md:flex-row md:items-center gap-2 md:gap-4">
                      <span className="text-xs font-mono font-bold text-point bg-teal-50 px-2.5 py-1 rounded-lg w-fit">26.08.17</span>
                      <p className="text-sm text-slate-700 font-medium">WMII PLAY SKIN for Beatoraja의 Bmz player 이용시 랜덤 패턴 표시가능, beatoraja는 현재 플레이스킨에선 미지원</p>
                    </div> 
                  </div>         
                   <div className="relative group">
                    <div className="absolute -left-[21px] top-1.5 w-2 h-2 rounded-full bg-point ring-4 ring-white transition-all group-hover:scale-125" />
                    <div className="flex flex-col md:flex-row md:items-center gap-2 md:gap-4">
                      <span className="text-xs font-mono font-bold text-point bg-teal-50 px-2.5 py-1 rounded-lg w-fit">26.08.13</span>
                      <p className="text-sm text-slate-700 font-medium">WMII PLAY SKIN for Beatoraja의 Bmz player 호환문제 수정, AC 14key practice 모드 문제 수정</p>
                    </div> 
                  </div>  
                            <div className="relative group">
                    <div className="absolute -left-[21px] top-1.5 w-2 h-2 rounded-full bg-point ring-4 ring-white transition-all group-hover:scale-125" />
                    <div className="flex flex-col md:flex-row md:items-center gap-2 md:gap-4">
                      <span className="text-xs font-mono font-bold text-point bg-teal-50 px-2.5 py-1 rounded-lg w-fit">26.08.09</span>
                      <p className="text-sm text-slate-700 font-medium">WMII PLAY SKIN에 봄 종류 추가, openLR2버전에 bomb_cn과 laneGlow 파츠 분리 적용, beatoraja ac스킨 노트 두께 수정, Duration 표기 추가</p>
                    </div> 
                  </div>  
                           <div className="relative group">
                    <div className="absolute -left-[21px] top-1.5 w-2 h-2 rounded-full bg-point ring-4 ring-white transition-all group-hover:scale-125" />
                  ...
                  <div className="relative group">
                   ...
                   <div className="relative group">
                    ...
                    <div className="flex flex-col md:flex-row md:items-center gap-2 md:gap-4">
                      ...
                      <p className="text-sm text-slate-700 font-medium">WMII PLAY SKIN for Beatoraja AC도 Lua로 변경하고 LaneCentering추가, 프레임 종류 추가</p>
                    </div> 
                  </div>  
                  <div className="relative group">
                    <div className="absolute -left-[21px] top-1.5 w-2 h-2 rounded-full bg-point ring-4 ring-white transition-all group-hover:scale-125" />
                    <div className="flex flex-col md:flex-row md:items-center gap-2 md:gap-4">
                      <span className="text-xs font-mono font-bold text-point bg-teal-50 px-2.5 py-1 rounded-lg w-fit">26.08.01</span>
                      <p className="text-sm text-slate-700 font-medium">WMII RESULT SKIN 코스 리절트에서 미러 등 랜덤 상태 표시가 안되던걸 수정</p>
                    </div> 
                  </div>
                             <div className="relative group">
                    <div className="absolute -left-[21px] top-1.5 w-2 h-2 rounded-full bg-point ring-4 ring-white transition-all group-hover:scale-125" />
                    <div className="flex flex-col md:flex-row md:items-center gap-2 md:gap-4">
                      ...
                      <p className="text-sm text-slate-700 font-medium">WMII PLAY SKIN for Beatoraja Wide의 다음랭크까지 남은점수 계산식 변경함, WIDE DP 스킨이 BACKBMP 있을때 타이틀 안뜨던거 수정</p>
                    </div> 
                  </div>
                       <div className="relative group">
                    <div className="absolute -left-[21px] top-1.5 w-2 h-2 rounded-full bg-point ring-4 ring-white transition-all group-hover:scale-125" />
